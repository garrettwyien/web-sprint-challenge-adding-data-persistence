...
SQL is a language that allows us to navigate and alter Relational Databases

2. Why do tables need a Primary Key?
Primary keys allow us to give unique identities to all entries in a given table.
...
An intermediary table where each primary key combination is unique. 